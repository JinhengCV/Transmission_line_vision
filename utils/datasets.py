...
class LoadImages:  # for inference
    ...
    def __next__(self):
        ...
        # img_resized = cv2.resize(img.transpose(1, 2, 0), (512, 512))
        # save_path = f'inference/output/processed_{self.count}.png'
        # cv2.imwrite(save_path, img_resized[:, :, ::-1]) 
...
def load_image(self, index):
    ...
    if img is None:  # not cached
        ...
        # img = llie(img)    #注释  JINHENGnew add
